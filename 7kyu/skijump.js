...
function skiJump(mountain) {
  ...
  return jumpLength < 10
    ? jumpLength + " metres: He's crap!"
    : jumpLength >= 10 && jumpLength < 25
    ? jumpLength + " metres: He's ok!"
    : jumpLength >= 25 && jumpLength < 50
    ? jumpLength + " metres: He's flying!"
    : jumpLength + " metres: Gold!!";
}
